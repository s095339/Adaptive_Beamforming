...
open_project Top_Kernel
set_top Top_Kernel
# v++ -g, -D, -I, --advanced.prop kernel.Top_Kernel.kernel_flags
add_files "/mnt/HLSNAS/04.HPOmGn/m111061549/BeamFormer/geqrf/Top_Kernel.cpp" -cflags " -I /ext -I /mnt/HLSNAS/04.HPOmGn/m111061549/BeamFormer/geqrf"
...
config_export -format xo -ipname Top_Kernel
